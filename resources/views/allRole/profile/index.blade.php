...
@section('content')
    <div class="w-screen h-screen max-h-screen overflow-hidden bg-white" x-data="{form_create_sales:false, table_sales:true, open_confirm:false}">
        <div style="margin-top:-33px; z-index:50;left:0;overflow: auto;" class="fixed w-screen h-full">
            <form>
                <div class="w-full px-0 pt-6 md:px-[100px] lg:px-[399px] bg-[#F9FAFB]">
                    <div>
                        <div style="font-weight: 700;" class="text-[24px] text-black pt-6">
                            Update Profile
                        </div>
                        ...
                        <div class="mb-20 p-6 bg-white">
                            <div class="flex justify-end">
                                <div>
                                    <button id="submit-button" type="button" onclick="saveProfile()" style="font-weight: 600;background-color: rgb(96 165 250 / var(--tw-bg-opacity));" class="w-[83px] h-[44px] text-white text-center text-[16px]">
                                        Save
                                    </button>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                $.ajax({
                    type: 'GET',
                    url: '{{ env('APP_URL').'/api/v1/profile' }}',
                    headers: {
